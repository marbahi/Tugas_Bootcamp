# Graph Report - Tugas_Bootcamp  (2026-08-18)

## Corpus Check
- 272 files · ~804,377 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1069 nodes · 1247 edges · 207 communities (194 shown, 13 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `03d4fa1f`
...
- `PasswordController` --inherits--> `Controller`  [EXTRACTED]
  e-commerce/app/Http/Controllers/Auth/PasswordController.php → Tugas_10/app/Http/Controllers/Controller.php
- `VerifyEmailController` --inherits--> `Controller`  [EXTRACTED]
  e-commerce/app/Http/Controllers/Auth/VerifyEmailController.php → Tugas_10/app/Http/Controllers/Controller.php
...
Cohesion: 0.07
Nodes (29): Cara menjalankan:, Cara menjalankan:, Cara menjalankan:, Cara menjalankan:, Cara menjalankan:, Cara menjalankan:, E-Commerce - Tugas Bootcamp, License (+21 more)
...
Cohesion: 0.05
Nodes (12): CartItemsController, HomeController, OrderItemsController, ProductsController, CartItems, OrderItems, Products, Illuminate\Database\Eloquent\Model (+4 more)

### Community 124 - "OrderItemsController"
Cohesion: 0.18
Nodes (6): AuthenticatedSessionController, EmailVerificationNotificationController, PasswordController, ProfileController, Illuminate\Http\RedirectResponse, Illuminate\Http\Request
...
Cohesion: 0.11
Nodes (10): ConfirmablePasswordController, EmailVerificationPromptController, NewPasswordController, PasswordResetLinkController, RegisteredUserController, AppLayout, Illuminate\View\View, Controller (+2 more)
...
Cohesion: 0.33
Nodes (3): App\Models\ProductCategories, CategoryController, ProductCategories

## Knowledge Gaps
- **298 isolated node(s):** `Yang sudah dikerjakan:`, `Cara menjalankan:`, `Struktur Database:`, `Yang sudah dikerjakan:`, `Cara menjalankan:` (+293 more)
...
- **Why does `Controller` connect `Controller` to `OrdersController`, `CartController`, `VerifyEmailController.php`, `HomeController`, `ProductController`, `ProductCategories`, `Illuminate\Http\Request`, `OrderItemsController`?**
