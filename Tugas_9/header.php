    ...
    <nav class="navbar">
        <div class="container">
            ...
            <div class="navbar-nav">
                ...
                <a href="keranjang.php" class="nav-link <?= $activePage === 'keranjang' ? 'active' : '' ?>">🛒 Keranjang</a>
                <?php if (isset($_SESSION['seller_login']) && $_SESSION['seller_login']): ?>
                    <a href="seller.php" class="nav-link <?= $activePage === 'seller' ? 'active' : '' ?>">📦 Kelola Produk</a>
                    <a href="order.php" class="nav-link <?= $activePage === 'order' ? 'active' : '' ?>">📋 Order</a>
                    <a href="logout.php" class="nav-link">👤 Logout</a>
                <?php else: ?>
                    <a href="login.php" class="nav-link <?= $activePage === 'login' ? 'active' : '' ?>">🔑 Masuk</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
