...
@section('content')
    <section class="carousel-section mt-4 mx-3">
            ...
            @for ($i = 1; $i <= 8; $i++)
                <div class="col">
                    <div class="card h-100 rounded-4">
                        <img src="https://placehold.co/300x200/e2e8f0/0f172a?text=Produk+{{ $i }}" class="card-img-top" alt="Produk {{ $i }}">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title">Produk {{ $i }}</h5>
                            <p class="card-text text-primary fw-bold">Rp{{ number_format($i * 50000, 0, ',', '.') }}</p>
